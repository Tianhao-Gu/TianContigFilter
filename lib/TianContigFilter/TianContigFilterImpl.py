...
class TianContigFilter:
    ...
    def run_TianContigFilter(self, ctx, params):
        """
        ...
        #BEGIN run_TianContigFilter

        # Print statements to stdout/stderr are captured and available as the App log
        print('Starting run_ContigFilter function. Params=')
        pprint(params)
        ...
        #END run_TianContigFilter

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_TianContigFilter return value ' +
